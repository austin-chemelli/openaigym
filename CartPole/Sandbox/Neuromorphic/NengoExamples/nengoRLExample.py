...
print(sys.path)
from nengo_fpga.networks.fpga_pes_ensemble_network import FpgaPesEnsembleNetwork
...
with model:
    ...
    adapt_ens = nengo.Ensemble(100 * radar_dim, radar_dim)

    nengo.Connection(stim_radar, adapt_ens, synapse=learn_synapse)
    nengo.Connection(errors, adapt_ensx)
    nengo.Connection(adapt_ens, bg.input)
